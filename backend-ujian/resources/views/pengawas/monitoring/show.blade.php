...
<div style="padding: 10px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
        <div>
            ...
            <p style="margin: 5px 0 0; color: #64748b;">Kelas: <strong>{{ $schedule->classroom->nama_kelas }}</strong> | Staf Pengawas: {{ auth()->user()->name }}</p>
        </div>
        <div style="display: flex; gap: 10px;">
            ...
            <a href="{{ route('pengawas.monitoring.index') }}" style="background: #1e293b; color: white; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-weight: 600;">
                Kembali
            </a>
        </div>
    </div>
